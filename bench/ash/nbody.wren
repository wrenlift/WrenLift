// Mirrors Ash's NBody: five bodies as objects with fields, 10,000,000
// steps of advance(0.01), then int(energy * 1e6). Expected: Energy: -169077
...
System.print("Energy: %((sim.energy() * 1000000).truncate)")
